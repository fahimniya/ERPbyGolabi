...
public class DBInitiation {
	public boolean initiate() {
		...
		flag = flag && db.update("create table SOFTWARESYSTEM(NAME VARCHAR(255) NOT NULL,PRIMARY KEY(NAME));");
		flag = flag && db.update(
		...
		flag = flag && db.update(
				"create table ORGANIZATIONUNIT(ID INT NOT NULL,PRIMARY KEY(ID));");
		flag = flag && db.update(
