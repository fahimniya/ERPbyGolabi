...
public class DBInitiation {
	public boolean initiate() {
		...
		flag = flag && db.update(
				"create table SOFTWARESYSTEM(NAME VARCHAR(255) NOT NULL,TECHNOLOGY VARCHAR(255),DESCRIPTION VARCHAR(255),PRIMARY KEY(NAME));");
		flag = flag && db.update(
		...
		flag = flag && db.update(
				"create table HUMANRESOURCE(USERNAME VARCHAR(255) NOT NULL,FROM_DATE DATE,TO_DATE DATE,PRIMARY KEY(USERNAME),FOREIGN KEY(USERNAME) REFERENCES USER(USERNAME));");
		flag = flag && db.update(
				"create table FACILITYRESOURCEALLOCATION(MODULENAME VARCHAR(255) NOT NULL,PROJECTNAME VARCHAR(255) NOT NULL,ID INT NOT NULL,TYPE VARCHAR(255) NOT NULL,FROM_DATE DATE NOT NULL,TO_DATE DATE NOT NULL,PRIMARY KEY(MODULENAME, PROJECTNAME, ID, FROM_DATE, TO_DATE),FOREIGN KEY(ID) REFERENCES FACILITYRESOURCE(ID),FOREIGN KEY(PROJECTNAME) REFERENCES SOFTWARESYSTEM(NAME));");
		flag = flag && db.update(
				"create table HUMANRESOURCEALLOCATION(MODULENAME VARCHAR(255) NOT NULL,PROJECTNAME VARCHAR(255) NOT NULL,USERNAME VARCHAR(255) NOT NULL,TYPE VARCHAR(255) NOT NULL,FROM_DATE DATE NOT NULL,TO_DATE DATE NOT NULL,PRIMARY KEY(MODULENAME, PROJECTNAME, USERNAME, FROM_DATE, TO_DATE),FOREIGN KEY(USERNAME) REFERENCES HUMANRESOURCE(USERNAME),FOREIGN KEY(PROJECTNAME) REFERENCES SOFTWARESYSTEM(NAME));");
		flag = flag && db.update(
				"create table FUNDINGRESOURCEALLOCATION(MODULENAME VARCHAR(255) NOT NULL,PROJECTNAME VARCHAR(255) NOT NULL,UNIT VARCHAR(255) NOT NULL,AMOUNT INT NOT NULL,TYPE VARCHAR(255) NOT NULL,FROM_DATE DATE NOT NULL,TO_DATE DATE NOT NULL,PRIMARY KEY(MODULENAME, PROJECTNAME, UNIT, AMOUNT, FROM_DATE, TO_DATE),FOREIGN KEY(UNIT) REFERENCES FUNDINGRESOURCE(UNIT),FOREIGN KEY(PROJECTNAME) REFERENCES SOFTWARESYSTEM(NAME));");
		flag = flag && db.update(
				"create table ORGANIZATIONUNIT(ID INT NOT NULL,NAME VARCHAR(255) NOT NULL UNIQUE,USERNAME VARCHAR(255) NOT NULL,PRIMARY KEY(ID),FOREIGN KEY(USERNAME) REFERENCES USER(USERNAME));");
		flag = flag && db.update(
